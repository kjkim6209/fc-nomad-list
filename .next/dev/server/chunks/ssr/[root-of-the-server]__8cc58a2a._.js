...
;
const metadata = {
    title: "Nomad List - Discover Your Next Destination",
    description: "Explore cities around the world, find digital nomad communities, and connect with fellow travelers.",
    generator: "v0.app",
    icons: {
        icon: [
            {
